...
class Adicionar extends StatefulWidget {
  Adicionar(this.title);
  String title;

  @override
  _AdicionarState createState() => _AdicionarState(title);
}

class _AdicionarState extends State<Adicionar> {
  _AdicionarState(this.title);
  String title;
        ...
        child: ElevatedButton(
          ...
          onPressed: () {
            if (controladornombre.text.isNotEmpty &&
              ...
              Navigator.pop(context, personasadd);
            }
          },
